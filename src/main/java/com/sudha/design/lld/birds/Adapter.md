...
<img alt="object adapter" src="{{ site.baseurl }}/src/main/resources/images/Adapter.png" width="70%"/>
...
<img alt="class adapter" src="{{ site.baseurl }}/src/main/resources/images/ClassAdapter.png" width="70%"/>
